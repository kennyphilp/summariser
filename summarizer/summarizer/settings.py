...
# Comprehensive logging setup for development and debugging
# Logs are written to both console and file for monitoring application behavior
LOGGING = {
    'version': 1,
    ...
    # Define where logs are sent (handlers)
    'handlers': {
        'file': {
            'level': 'INFO',
            'class': 'logging.FileHandler',
            'filename': 'logs/django.log',  # Log file location
            'formatter': 'verbose',  # Detailed format for file logs
        },
        'console': {
            'level': 'INFO',
    ...
    # Specific logger for Django framework
    'loggers': {
        'django': {
            'handlers': ['console', 'file'],
            'level': 'INFO',
